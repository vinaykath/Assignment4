...
# Here, it's used to test various scenarios of arithmetic operations
...
def test_calculation_repr():
    ...
    assert calc.__repr__() == expected_repr, "__repr__ output does not match the expected string."
...
def test_divide_by_zero():
    ...
    as dividing by zero is mathematically undefined and should be handled as an error.
    """
